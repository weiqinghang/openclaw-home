...
- `{baseDir}/scripts/trade_parse_request.py`
- `{baseDir}/scripts/trade_generate_quote_from_bitable.py`
- `{baseDir}/scripts/feishu_trade_bitable_upsert.js`
- `{baseDir}/scripts/feishu_trade_send_file.js`
...
```bash
python3 {baseDir}/scripts/trade_parse_request.py --message "<用户原话>"
```
...
```bash
python3 {baseDir}/scripts/trade_generate_quote_from_bitable.py \
...
```bash
node {baseDir}/scripts/feishu_trade_bitable_upsert.js propose '<解析后的 JSON>'
```
...
```bash
node {baseDir}/scripts/feishu_trade_bitable_upsert.js apply
```
